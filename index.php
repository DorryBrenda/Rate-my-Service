...
<body class="agileits_w3layouts">
    <h1 class="agile_head text-center">Rate my Service</h1>
	  ...
	  <h3>Please help us to serve you better by taking a couple of minutes. </h3>
	    <form action="feedback.php" method="post" class="agile_form">
		  <h2>How satisfied were you with our Service?</h2>
            ...
            <h2>How likely are you to recommend our services</h2>
            <ul class="agile_info_select">
                <li><input type="radio" name="view" value="Very likely" id="Very likely" required>
                    <label for="Very likely">Very likely</label>
                    <div class="check w3"></div>
                </li>
                <li><input type="radio" name="view" value="Likely" id="Likely">
                    <label for="Likely"> Likely</label>
                    <div class="check w3ls"></div>
                </li>
                <li><input type="radio" name="view" value="Dislikely" id="Dislikely">
                    <label for="Dislikely">Dislikely</label>
                    <div class="check wthree"></div>
                </li>
                <li><input type="radio" name="view" value="Very dislikely" id="Very dislikely">
                    <label for="Very dislikely">Very dislikely</label>
                    <div class="check w3_agileits"></div>
                </li>
            </ul>
			<h2>If you have ways that can help us to improve on our services, please write to us...</h2>
